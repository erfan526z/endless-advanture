...
Recipes::Recipes() {
	...
	list[auto_add].setInput(0, &gamedata::items.spruce_planks, 1);
	list[auto_add].setInput(1, &gamedata::items.spruce_planks, 1);
	list[auto_add].setInput(2, &gamedata::items.spruce_planks, 1);
	list[auto_add].setInput(3, &gamedata::items.spruce_planks, 1);
	list[auto_add].setInput(5, &gamedata::items.spruce_planks, 1);
	list[auto_add].setInput(6, &gamedata::items.spruce_planks, 1);
	list[auto_add].setInput(7, &gamedata::items.spruce_planks, 1);
	list[auto_add].setInput(8, &gamedata::items.spruce_planks, 1);
	...
	list[auto_add].setInput(0, &gamedata::items.maple_planks, 1);
	list[auto_add].setInput(1, &gamedata::items.maple_planks, 1);
	list[auto_add].setInput(2, &gamedata::items.maple_planks, 1);
	list[auto_add].setInput(3, &gamedata::items.maple_planks, 1);
	list[auto_add].setInput(5, &gamedata::items.maple_planks, 1);
	list[auto_add].setInput(6, &gamedata::items.maple_planks, 1);
	list[auto_add].setInput(7, &gamedata::items.maple_planks, 1);
	list[auto_add].setInput(8, &gamedata::items.maple_planks, 1);
	list[auto_add].setOutput(0, &gamedata::items.barrel, 1);
	auto_add++;
	
	list[auto_add].setInput(0, &gamedata::items.birch_planks, 1);
	list[auto_add].setInput(1, &gamedata::items.birch_planks, 1);
	list[auto_add].setInput(2, &gamedata::items.birch_planks, 1);
	list[auto_add].setInput(3, &gamedata::items.birch_planks, 1);
	list[auto_add].setInput(5, &gamedata::items.birch_planks, 1);
	list[auto_add].setInput(6, &gamedata::items.birch_planks, 1);
	list[auto_add].setInput(7, &gamedata::items.birch_planks, 1);
	list[auto_add].setInput(8, &gamedata::items.birch_planks, 1);
	list[auto_add].setOutput(0, &gamedata::items.barrel, 1);
	auto_add++;
	
	list[auto_add].setInput(0, &gamedata::items.acacia_planks, 1);
	list[auto_add].setInput(1, &gamedata::items.acacia_planks, 1);
	list[auto_add].setInput(2, &gamedata::items.acacia_planks, 1);
	list[auto_add].setInput(3, &gamedata::items.acacia_planks, 1);
	list[auto_add].setInput(5, &gamedata::items.acacia_planks, 1);
	list[auto_add].setInput(6, &gamedata::items.acacia_planks, 1);
	list[auto_add].setInput(7, &gamedata::items.acacia_planks, 1);
	list[auto_add].setInput(8, &gamedata::items.acacia_planks, 1);
	list[auto_add].setOutput(0, &gamedata::items.barrel, 1);
	auto_add++;
	
	list[auto_add].setInput(0, &gamedata::items.jungle_planks, 1);
	list[auto_add].setInput(1, &gamedata::items.jungle_planks, 1);
	list[auto_add].setInput(2, &gamedata::items.jungle_planks, 1);
	list[auto_add].setInput(3, &gamedata::items.jungle_planks, 1);
	list[auto_add].setInput(5, &gamedata::items.jungle_planks, 1);
	list[auto_add].setInput(6, &gamedata::items.jungle_planks, 1);
	list[auto_add].setInput(7, &gamedata::items.jungle_planks, 1);
	list[auto_add].setInput(8, &gamedata::items.jungle_planks, 1);
	list[auto_add].setOutput(0, &gamedata::items.barrel, 1);
	auto_add++;
...
BlockData::BlockData()
{
	...
	// Maple Planks
	indexer[auto_add] = &maple_planks;
	maple_planks = Block(auto_add, "Maple Planks", gamedata::MATERIAL_WOOD, gamedata::TEXTURE_MAPLE_PLANKS, &gamedata::items.maple_planks);
	maple_planks.setBreaingTime(2.0f);
	auto_add++;
	
	// Birch Planks
	indexer[auto_add] = &birch_planks;
	birch_planks = Block(auto_add, "Birch Planks", gamedata::MATERIAL_WOOD, gamedata::TEXTURE_BIRCH_PLANKS, &gamedata::items.birch_planks);
	birch_planks.setBreaingTime(2.0f);
	auto_add++;
	
	// Acacia Planks
	indexer[auto_add] = &acacia_planks;
	acacia_planks = Block(auto_add, "Acacia Planks", gamedata::MATERIAL_WOOD, gamedata::TEXTURE_ACACIA_PLANKS, &gamedata::items.acacia_planks);
	acacia_planks.setBreaingTime(2.0f);
	auto_add++;
	
	// Jungle Planks
	indexer[auto_add] = &jungle_planks;
	jungle_planks = Block(auto_add, "Jungle Planks", gamedata::MATERIAL_WOOD, gamedata::TEXTURE_JUNGLE_PLANKS, &gamedata::items.jungle_planks);
	jungle_planks.setBreaingTime(2.0f);
	auto_add++;
